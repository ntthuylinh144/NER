...
#             "id": 1,
#             "entities": [
#                 {"text": "Hold", "label": "ACTION"},
#                 {"text": "device", "label": "COMPONENT"},
#                 {"text": "surface", "label": "LOCATION"}
#             ]
#         },
#         # Text 2 - some repeats, some similar
#         {
#             "id": 2,
#             "entities": [
#                 {"text": "hold", "label": "ACTION"},  # Same as "Hold"
#                 {"text": "Device", "label": "COMPONENT"},  # Same as "device"
#                 {"text": "mounting surface", "label": "LOCATION"},  # Similar to "surface"
#                 {"text": "bolt", "label": "COMPONENT"}  # New
#             ]
#         },
#         # Text 3 - more new entities
#         {
#             "id": 3,
#             "entities": [
#                 {"text": "Insert", "label": "ACTION"},
#                 {"text": "bolt", "label": "COMPONENT"},  # Repeat
#                 {"text": "hole", "label": "LOCATION"}
#             ]
#         }
#     ]
#
#     # Process each text
#     for text_data in texts_with_entities:
#         text_id = text_data["id"]
#         print(f"\n--- Processing Text {text_id} ---")
#
#         # Get context before processing
#         context = manager.get_entity_context(max_entities=20)
#         print(f"Context provided: {context}")
#
#         # Process entities
#         results = manager.process_extraction_results(
#             text_data["entities"],
#             text_id
#         )
#
...
#             status = "NEW" if result["is_new"] else "LINKED"
#             print(f"  [{status}] {result['text']} -> Entity #{result['entity_id']} "
#                   f"({result['canonical_text']}, {result['occurrences']} occurrences)")
#
#     # Print summary
#     manager.print_summary()
#
#     # Save to file
#     manager.save_to_file("entity_list.json")
#
#     print("\n✅ Entity Manager test complete!")
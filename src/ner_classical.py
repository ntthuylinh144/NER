...
#     for technical domain entities (ACTION, COMPONENT, LOCATION).
#     """
#
...
#                 doc.ents = spans
#             except ValueError:
#                 # Remove overlaps: keep longest spans first
#                 non_overlapping = []
#                 seen = set()
#
...
#     ner_trained = ClassicalNER(model_path="model_ner")
#
#     # Test extraction
#     test_text = "Hold the device up to the surface prepared for screw fastening."
#     entities = ner_trained.extract_entities(test_text)
#
#     print(f"\nText: {test_text}")
#     print(f"\nExtracted Entities:")
